...
- Portable hypergraph output compatible with the `BhaveshY/hypergraph` `DataNode` JSON shape, including recursive tree, flattened nodes, multi-member hyperedges, incidence records, and subdivision/adjacency/area/angle/incidence matrices.
